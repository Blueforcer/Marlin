...
//#define INVERT_Z2_VS_Z_DIR true   // Set 'true' if Z motors should rotate in opposite directions
...
#define Z_STEPPER_AUTO_ALIGN
  ...
  #define Z_STEPPER_ALIGN_XY { {  10, 180  }, {  300, 180  } }
