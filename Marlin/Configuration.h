...
#define STRING_CONFIG_H_AUTHOR "(mehrwiedu, Ender-5-Plus)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender5 PLUS"
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -44.0, -5.0, -2.0 }
